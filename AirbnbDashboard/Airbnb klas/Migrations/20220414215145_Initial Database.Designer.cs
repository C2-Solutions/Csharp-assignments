...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Airbnb_klas.Model.Customer", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Airbnb_klas.Model.House", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Airbnb_klas.Model.Landlord", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Airbnb_klas.Model.Reservation", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Airbnb_klas.Model.House", b =>
                {
                    b.HasOne("Airbnb_klas.Model.Landlord", "Landlord")
                        .WithMany("Houses")
            ...
            modelBuilder.Entity("Airbnb_klas.Model.Reservation", b =>
                {
                    b.HasOne("Airbnb_klas.Model.Customer", "Customer")
                        .WithMany("Reservations")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Airbnb_klas.Model.House", "House")
                        .WithMany("Reservations")
